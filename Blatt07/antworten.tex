...
\begin{enumerate}
 ...
 \item Jeder Prozess braucht in jeder Iteration den oben ($z_{u}$) und unten ($z_o$) benachbarten Teil der Matrix. Angehängt ist die Nummer des Bereichs, die der Prozess bearbeitet (abgesehen von den Prozessen mit benachbarten 0er-Reihen).
 \item Jeder Prozess sendet am Anfang einer Iteration seine von anderen Prozessen benötigten Halolines und fragt am Anfang die obere benötigte Haloline ab, am Ende die untere.
 \item Wenn genug Iterationen durchgeführt wurden, brechen die Prozesse eigenständig ab.
...
Eine Unnötigkeit bei oben beschriebenem Prozess ist, dass jeder Prozess zu jeder Iteration sein MaxResiduum an p0 schickt, damit der Präzisions-Abbruch korrekt geschehen kann. Dies kann umgangen werden, indem jeder Prozess dies eigenständig überprüüft.
\end{document}
