...
calculate_new (struct calculation_arguments const* arguments, struct calculation_results* results, struct options const* options)
{
	...
	#pragma omp parallel num_threads(options->number) default(none) private(star, residuum, i, j, star, residuum, pih, fpisin, term_iteration) shared(arguments, options, results, maxResiduum, N, h,  m1, m2)
	{
